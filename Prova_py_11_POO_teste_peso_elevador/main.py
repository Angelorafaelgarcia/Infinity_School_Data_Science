...
# a capacidade máxima do elevador, a capacidade atual, o total de andares do prédio e o andar
# atual do elevador.

# A classe Elevador também possui os seguintes métodos:

# Subir(): caso o elevador não esteja no andar mais alto, o método incrementa o número do andar atual
# e exibe "Subindo". Caso contrário, exibe "VOCÊ ESTÁ NO ANDAR MAIS ALTO!".

# Descer(): caso o elevador não esteja no térreo, o método decrementa o número do andar atual e exibe
# "Descendo". Caso contrário, exibe "VOCÊ JÁ ESTÁ NO TÉRREO!".

# Entrar(): caso a capacidade atual do elevador não tenha sido atingida, o método incrementa o
# número de pessoas presentes no elevador e exibe "Entrando uma pessoa". Caso contrário, exibe
...
# # Exemplo de uso
elevador = Elevador(totalCapacidade=10, totalAndar=20)
elevador.entrar()
elevador.subir()
elevador.entrar()
elevador.subir()
